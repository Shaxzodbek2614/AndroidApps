...
import com.example.contacthelper.databinding.FragmentSendMessageBinding
...
//                    val smsManager:SmsManager = requireContext().getSystemService(SmsManager::class.java)
                        ...
                        smsManager.sendTextMessage(param1?.number, null, message, null, null)
